...
instance Show Command where
  ...
  show (DrawImage (a1,a2,a3)) = "c.drawImage(" ++ showI a1 ++ "," ++ showJ a2 ++ "," ++ showJ a3 ++ ")"
  ...
  show (GlobalCompositeOperation (a1)) = "c.globalCompositeOperation(" ++ show a1 ++ ")"
...
drawImage :: (Image,Float,Float) -> Canvas ()
